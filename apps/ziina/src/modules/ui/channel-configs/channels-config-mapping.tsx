...
import { type ZiinaFrontendConfigSerializedFields } from "@/modules/app-config/domain/ziina-config";

type Props = {
  channels: ChannelFragment[];
  configs: ZiinaFrontendConfigSerializedFields[];
  mapping: Record<string, ZiinaFrontendConfigSerializedFields>;
